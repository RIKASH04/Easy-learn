...
export default function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    setMessage('Check your email for the confirmation link, or sign in with Google.')
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-6 sm:py-12 pb-safe">
      ...
      >
        <div className="rounded-2xl bg-slate-800/50 border border-slate-700/50 p-5 sm:p-8 shadow-xl">
          <h1 className="text-xl sm:text-2xl font-bold text-white text-center">Create your account</h1>
          <p className="text-slate-400 text-center mt-2 text-sm">Start learning with Easy Learn</p>
